...
const AttendanceRev = (props) => {
  ...
  return (
    <>
      <View style={{flex:1}}>
        <View style={{height:'80%', marginRight:'1%', borderColor:'#000', backgroundColor:'#FBFBFB'}}>
          <FlatList
            data={dataOvertime}
        ...
        <View style={{height:'20%'}}>
          ...
          <View style={{justifyContent:'center'}}>
            <View style={{marginTop:'1%'}}>
              <TouchableOpacity style={{backgroundColor:'#2180D9', width:'40%', alignSelf:'center', height:50, borderRadius:25, justifyContent:'center'}} onPress={() => navigate('AttendanceRevForm')}>
...
AttendanceRev.navigationOptions = ({navigation}) => ({
