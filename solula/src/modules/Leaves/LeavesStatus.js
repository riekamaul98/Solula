      ...
      <TouchableOpacity
        ...
        <View
          ...
          <Text style={{color: '#434343', fontSize: 13, fontWeight: 'bold'}}>
            {item.employee_id === false ? '' : item.employee_id[1]}
          </Text>
        </View>
        ...
        <View style={{flex: 1}}>
          <View
            ...
            <View
              ...
              <Text style={{color: '#434343', fontSize: 13}}>{item.state}</Text>
            </View>
            <MaterialIcons
              style={{
              ...
              name={item.state === 'confirm' ? 'check-circle' : 'cancel'}
              color={item.state === 'confirm' ? '#005243' : 'red'}
              size={23}
            />
          </View>
        </View>
...
const LeavesStatus = (props) => {
  ...
  const data = async () => {
    ...
    const response = await leaveStatus(
...
LeavesStatus.navigationOptions = ({navigation}) => ({
  title: 'Status',
